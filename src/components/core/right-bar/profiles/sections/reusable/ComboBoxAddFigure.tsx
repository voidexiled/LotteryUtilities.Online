...
export function ComboBoxAddSkipFigure() {
	...
	const handleAddSkipFigure = () => {
		...
		if (!_localProfile.tableOptions.skipFigures.includes(selectedFigure.id)) {
			_localProfile.tableOptions.skipFigures.push(selectedFigure.id);
		}
